...
import 'package:laundry_app/config/app_format.dart';
...
class DetailShopPage extends StatelessWidget {
  ...
  Widget groupItemInfo(BuildContext context) {
    return Padding(
                          ...
                          : Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  if (shop.pickup) DView.spaceWidth(8),
                                  if (shop.pickup) childOrder('Delivery'),
                                ],
                              ),
                            ),
                    ],
